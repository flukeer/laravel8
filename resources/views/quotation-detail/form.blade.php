<div class="form-group {{ $errors->has('quotation_id') ? 'has-error' : '' }}">
    ...
    <input class="form-control" name="quotation_id" type="number" id="quotation_id"
        value="{{ isset($quotationdetail->quotation_id) ? $quotationdetail->quotation_id : request('quotation_id') }}"
        readonly>
...
<div class="form-group {{ $errors->has('amount') ? 'has-error' : '' }}">
    ...
    <input class="form-control" name="amount" type="number" id="amount"
        value="{{ isset($quotationdetail->amount) ? $quotationdetail->amount : '' }}">
    {!! $errors->first('amount', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
    <label for="price" class="control-label">{{ 'Price' }}</label>
    <input class="form-control" name="price" type="number" id="price"
        value="{{ isset($quotationdetail->price) ? $quotationdetail->price : '' }}">
